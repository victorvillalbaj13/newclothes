...
export default function WhatsAppButton() {
  const phone = "584124373329";

  const message = encodeURIComponent(
    "Hola NEWCLOTHES 👋 Estoy interesado en sus productos."
  );
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[9999] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_rgba(37,211,102,0.45)]"
    >
      <svg
